(ns clojuredocs.api.examples-test
  ...
  changes between edits. Historical duplicates are collapsed on the next edit."
...
(deftest add-editor-collapses-historical-duplicates
  (testing "pre-existing duplicate identities collapse to one refreshed entry"
    (is (= [alice-v2 bob]
           ((examples/add-editor alice-v2) [alice-v1 alice-v1 bob])))
    (is (= [bob alice-v2]
           ((examples/add-editor alice-v2) [bob alice-v1 alice-v1])))))